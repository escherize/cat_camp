...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj24833 = {};return obj24833;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__21948__auto__ = this$;if(and__21948__auto__)
...
{var x__22597__auto__ = (((this$ == null))?null:this$);return (function (){var or__21960__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__22597__auto__)]);if(or__21960__auto__)
{return or__21960__auto__;
} else
{var or__21960__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__21960__auto____$1)
...
return (function (p__24834){var vec__24835 = p__24834;var k = cljs.core.nth.call(null,vec__24835,(0),null);var v = cljs.core.nth.call(null,vec__24835,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
