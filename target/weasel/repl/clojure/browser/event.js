...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj23481 = {};return obj23481;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__21948__auto__ = this$;if(and__21948__auto__)
...
{var x__22597__auto__ = (((this$ == null))?null:this$);return (function (){var or__21960__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__22597__auto__)]);if(or__21960__auto__)
{return or__21960__auto__;
} else
{var or__21960__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__21960__auto____$1)
...
return (function (p__23482){var vec__23483 = p__23482;var k = cljs.core.nth.call(null,vec__23483,(0),null);var v = cljs.core.nth.call(null,vec__23483,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__23484){var vec__23485 = p__23484;var k = cljs.core.nth.call(null,vec__23485,(0),null);var v = cljs.core.nth.call(null,vec__23485,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
