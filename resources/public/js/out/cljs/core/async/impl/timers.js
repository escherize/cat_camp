...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14727 = (0);while(true){
if((i_14727 < arr.length))
{(arr[i_14727] = null);
{
...
{var i_14734 = (self__.level + (1));while(true){
if((i_14734 <= (new_level + (1))))
{(update[i_14734] = self__.header);
{
var G__14735 = (i_14734 + (1));
i_14734 = G__14735;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14736 = (0);while(true){
if((i_14736 <= self__.level))
{var links_14737 = (update[i_14736]).forward;if(((links_14737[i_14736]) === x__$1))
{(links_14737[i_14736] = (x__$1.forward[i_14736]));
{
