...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14807 = (0);while(true){
var m_14808 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14808 == null))
{} else
{m_14808.call(null);
if((count_14807 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14809 = (count_14807 + (1));
count_14807 = G__14809;
continue;
}
} else
{}
