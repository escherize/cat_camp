...
{return (function() { 
var G__9747__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__9750 = o;(G__9750[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__9750;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__9751){var vec__9753 = p__9751;var id = cljs.core.nth.call(null,vec__9753,(0),null);var class$ = cljs.core.nth.call(null,vec__9753,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_9754 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_9754 === "key")))
{(o[pname_9754] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__9757 = jsprops;(G__9757["defaultValue"] = value);
(G__9757["value"] = null);
(G__9757["onChange"] = ((function (G__9757,on_change,value){
return (function (p1__9755_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9755_SHARP_);
});})(G__9757,on_change,value))
);
return G__9757;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__9759 = spec;(G__9759["componentDidUpdate"] = ((function (G__9759){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__9759))
);
(G__9759["componentWillUnmount"] = ((function (G__9759){
...
return (function (p1__9760_SHARP_,p2__9761_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__9760_SHARP_,p2__9761_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__9763 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__9763,(0),null);var id = cljs.core.nth.call(null,vec__9763,(1),null);var class$ = cljs.core.nth.call(null,vec__9763,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__9765 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__9765,(0),null);var id_class = cljs.core.nth.call(null,vec__9765,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_9766 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__9767 = (((k_9766 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_9766);if((k_SINGLEQUOTE__9767 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__9767);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4510__auto___9768 = a.length;var i_9769 = (0);while(true){
if((i_9769 < n__4510__auto___9768))
{(a[i_9769] = reagent.impl.template.as_component.call(null,(a[i_9769]),level_SINGLEQUOTE_));
{
